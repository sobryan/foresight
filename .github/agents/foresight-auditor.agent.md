...
1. **Audit the corpus.** Run:
   ```bash
   python3 .github/skills/foresight/scripts/foresight.py audit --project "<project>" --json
   ```
   ...
   ```bash
   python3 .github/skills/foresight/scripts/foresight.py audit --project "<project>" --fix-run-command
   ```
...
2. **Build/refresh coverage.** Run:
   ```bash
   python3 .github/skills/foresight/scripts/foresight.py coverage --project "<project>" --json
   ```
