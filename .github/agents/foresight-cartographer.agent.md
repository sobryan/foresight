...
`<project>/.tdd/foresight/inventory/inventory.json` and a readable `inventory.md`. Schema: `.github/.github/skills/foresight/reference/coverage-model.md`; validated by `.github/.github/skills/foresight/reference/schemas/inventory.schema.json`. At minimum, populate:
